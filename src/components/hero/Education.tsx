    ...
    >
      ...
      <div
        className=" absolute w-screen
         flex sm:justify-center space-x-5 snap-x snap-mandatory lg:overflow-x-hidden  overflow-y-hidden   scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-red-500 "
      >
