...
const BackGroundCircles = () => {
  return (
    ...
    >
      ...
      <div
        className={
          "absolute border border-[#F7AB0A] rounded-full h-[650px] w-[650px] opacity-20  mt-52 animate-pulse"
        }
      />
      <div
        className={
          "absolute border border-[#fdd2d2] rounded-full h-[800px] w-[800px]  mt-52"
        }
      />
    </motion.div>
  );
